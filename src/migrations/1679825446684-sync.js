...
exports.sync1679825446684 = void 0;
var sync1679825446684 = /** @class */ (function () {
    function sync1679825446684() {
        this.name = 'sync1679825446684';
    }
    sync1679825446684.prototype.up = function (queryRunner) {
    ...
    sync1679825446684.prototype.down = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, queryRunner.query("\n            ALTER TABLE \"picking\" DROP CONSTRAINT \"FK_0e6c0767733d3dc7d0cd32591bc\"\n        ")];
    ...
    return sync1679825446684;
}());
exports.sync1679825446684 = sync1679825446684;
